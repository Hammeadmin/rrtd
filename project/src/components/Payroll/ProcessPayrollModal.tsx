    ...
    const fetchData = useCallback(async () => {
        ...
        try {
            ...
            const [infoRes, relRes, presetsRes] = await Promise.all([
                ...
                supabase.from('employer_employee_relationship').select('*').eq('employee_id', employeeId).single(),
            ...
            setTaxPercentage(infoRes.data?.tax_percentage || 30);
